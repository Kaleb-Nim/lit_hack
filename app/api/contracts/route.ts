    ...
    const records = objects
      ...
      .map((object) => {
        ...
        return {
          ...
          updatedRequirement: metadata?.updatedRequirement ?? "Assess and notify qualifying breaches",
          reason: metadata?.reason ?? "Stored contract requires validation against the PDPA data-breach notification framework.",
