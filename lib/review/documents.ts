      ...
      clauses: [
        {
          ...
          after:
            ", giving such details of the Data Breach as are then known to it.",
        },
        {
          number: "6.2",
          before:
  ...
  changes: [
    {
      ...
      title:
        "Breach notice: “without undue delay” → 24 hours to support statutory assessment",
      rationale:
    ...
    },
    {
      ...
      title:
        "Breach assistance tied to the statutory window and its required content",
      rationale:
...
const CALLOWAY_MSA: Omit<ReviewDocument, "id" | "reviewer"> = {
  ...
  changes: [
    ...
    },
    {
      ...
      replaced:
        "return or delete Customer Personal Data on expiry or termination of this Agreement",
      obligationId: "o2",
    },
    {
      id: "c3",
      ...
      title:
        "Data protection cap recalculated against the raised statutory maximum",
      rationale:
      ...
      replaced:
        "S$1,000,000, being the maximum financial penalty then imposable under the Act",
      obligationId: "o4",
    },
  ],
};
...
const CLOUD_HOSTING_DPA: Omit<ReviewDocument, "id" | "reviewer"> = {
  ...
  signatories: [
    "For Meridian Labs Pte Ltd",
    "For Northgate Cloud Services Pte Ltd",
  ],
  sections: [
    {
      heading: "8. Liability",
      clauses: [
        ...
        },
        {
          ...
          after:
            ", and shall be recalculated at the date of the breach rather than the date of this Agreement.",
        },
      ],
    },
    {
  ...
  changes: [
    {
      ...
      replaced:
        "S$1,000,000, being the maximum financial penalty imposable under the Act",
      obligationId: "o4",
    },
    {
      id: "c2",
      ...
      title:
        "Incident notice: “within a reasonable time” → 24 hours to support assessment",
      rationale:
    ...
    },
    {
      ...
      replaced:
        "return Controller Data to the Controller in the format in which it was received",
      obligationId: "o2",
    },
  ],
};
  ...
  sections: [
    {
      ...
      clauses: [
        ...
        },
        {
          ...
          changeId: "c1",
          before:
            "The client may collect, use and disclose the Employee's personal data for the purposes of managing the employment relationship",
          after: ".",
        },
        {
          number: "11.7",
    ...
    },
    {
      ...
      clauses: [
        ...
        },
        {
          ...
          changeId: "c3",
          before:
            "The client may terminate the employment without notice or payment in lieu where the Employee",
          after: ".",
        },
      ],
    },
  ...
  changes: [
    {
      ...
      text: "on the basis of the Employee's consent given by signing this Agreement or, where the client's legitimate interests outweigh any likely adverse effect on the Employee, on the basis of a written assessment completed and retained by the client under Part 3 of the First Schedule to the Act and made available to the Employee on request",
      replaced:
        "with the Employee's consent, which the Employee gives by signing this Agreement",
      obligationId: "o3",
    },
    {
      id: "c2",
      ...
      text: "shall not disclose personal data held by the client other than as required in the proper performance of the Employee's duties; shall not use personal data to obtain a gain for the Employee or any other person, or to cause harm or loss to any person; and shall not re-identify, or attempt to re-identify, any anonymised data held by the client. The Employee acknowledges that knowing or reckless conduct of that kind is an offence under section 48D of the Act, independently of any liability of the client",
      replaced:
        "shall not disclose personal data held by the client other than as required in the proper performance of the Employee's duties",
      obligationId: "o5",
    },
    {
      id: "c3",
      ...
      rationale:
        "Linking the offence to gross misconduct lets the client act on the conduct itself without waiting for a prosecution, and answers the vicarious-liability exposure noted against s. 48D.",
...
const HAND_WRITTEN: Record<
  HandWrittenId,
  Omit<ReviewDocument, "id" | "reviewer">
> = {
...
const GENERATED_META: Record<GeneratedId, GeneratedMeta> = {
  ...
  "standard-dpa-form": {
    ...
    voice: {
      subject: "The Processor",
      mid: "the Processor",
      counterparty: "the Controller",
      poss: "its",
    },
  },
  "standard-employment-form": {
    ...
    originalLabel: "Precedent v2025.2",
    revisedLabel: "v2026.1 draft · click an insertion to edit it",
    signatories: ["For the client", "Signed by the Employee"],
    voice: {
  ...
  "standard-mnda-form": {
    ...
    voice: {
      subject: "The Receiving Party",
      mid: "the Receiving Party",
      counterparty: "the Disclosing Party",
      poss: "its",
    },
  },
  "data-protection-policy": {
    ...
    voice: {
      subject: "The firm",
      mid: "the firm",
      counterparty: "the Data Protection Officer",
      poss: "its",
    },
  },
  ...
  "outside-counsel-guidelines": {
    ...
    voice: {
      subject: "Counsel",
      mid: "counsel",
      counterparty: "the firm",
      poss: "its",
    },
  },
};

type Wording = Pick<Change, "title" | "text" | "replaced"> &
  Pick<Clause, "before" | "after">;
...
const TEMPLATES: Record<ObligationId, Template> = {
  o1: {
    ...
    definition: () => ({
      ...
      replaced:
        "that is likely to result in significant harm to an affected individual",
  ...
  o2: {
    ...
    primary: (v) => ({
      title:
        "Future-ready machine-readable transmission, with derived data carved out",
      before: `On written request, ${v.mid} shall`,
      replaced:
        "return or destroy all personal data on termination of the relationship",
  ...
  o3: {
    ...
    primary: (v) => ({
      title:
        "Legitimate interests basis added, subject to a retained written assessment",
  ...
  o4: {
    ...
    companion: () => ({
      ...
      before:
        "Any cap expressed by reference to a statutory maximum shall be read as referring to the maximum",
  ...
  o5: {
    ...
    primary: (v) => ({
      title: "Express prohibition naming the s. 48D mishandling offence",
      before:
        v.employment || v.subject === "Counsel"
          ? `${v.subject} shall`
          : "Personnel shall",
...
function policyNote(file: AffectedFile, ref: string) {
  ...
  for (const o of OBLIGATIONS) {
    const note = o.policies.find(
      (p) =>
        p.name.toLowerCase() === policyName(file) &&
        p.clause.startsWith(`§ ${ref} `),
    );
...
function obligationForClause(
  ...
  const byDocList = OBLIGATIONS.find((o) =>
    o.docs.some(
      (d) => d.docId === file.docId && parseClauseRefs(d.clauses).includes(ref),
    ),
  );
...
function numberFor(ref: string): {
  ...
  if (ref.includes(".")) {
    ...
    return {
      major,
      clause: ref,
      intro: minor > 1 ? `${major}.${minor - 1}` : undefined,
    };
  }
  ...
  slots.forEach((slot, i) => {
    ...
    if (existing) {
      for (const c of clauses)
        if (!existing.clauses.some((e) => e.number === c.number))
          existing.clauses.push(c);
    } else {
      sections.push({ heading, clauses });
    }

    const clauseLabel = isPolicy
      ? `§ ${clauseNumber}`
      : isAnnex
        ? `Annex ${clauseNumber}`
        : `Clause ${clauseNumber}`;
...
function buildAll(): Record<DocId, ReviewDocument> {
  ...
  const isHandWritten = (id: DocId): id is HandWrittenId =>
    Object.prototype.hasOwnProperty.call(HAND_WRITTEN, id);
